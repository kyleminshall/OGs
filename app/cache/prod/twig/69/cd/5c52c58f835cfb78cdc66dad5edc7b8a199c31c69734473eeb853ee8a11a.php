...
class __TwigTemplate_69cd5c52c58f835cfb78cdc66dad5edc7b8a199c31c69734473eeb853ee8a11a extends Twig_Template
{
...
";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["post"]) {
            // line 19
            echo "            ";
            $this->env->loadTemplate("OGClubBundle:Page:main.html.twig", "1186898315")->display($context);
            // line 29
            echo "        ";
        ...
        // line 38
        echo "        ";
        if ((twig_length_filter($this->env, $this->getContext($context, "posts")) > 1)) {
            // line 39
            echo "            <span>
\t\t\t\t";
            // line 40
            if (($this->getContext($context, "current_page") > 1)) {
                // line 41
                echo "                <a style=\"text-decoration:none;color:#1F80C9;\" href=\"?page=";
                echo twig_escape_filter($this->env, ($this->getContext($context, "current_page") - 1), "html", null, true);
                echo "\">Previous</a>&nbsp;
\t\t\t\t";
            }
            // line 43
            echo "\t\t\t\t";
            if ((!$this->getContext($context, "last_page"))) {
                // line 44
                echo "                <a style=\"text-decoration:none;color:#1F80C9;\" href=\"?page=";
                echo twig_escape_filter($this->env, ($this->getContext($context, "current_page") + 1), "html", null, true);
                echo "\">&nbsp;Next</a>
...
/* OGClubBundle:Page:main.html.twig */
class __TwigTemplate_69cd5c52c58f835cfb78cdc66dad5edc7b8a199c31c69734473eeb853ee8a11a_1186898315 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);
    ...
    {
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "post"), "count"), "html", null, true);
    }

    // line 23
    public function block_likes($context, array $blocks = array())
    {
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "post"), "likes"), "html", null, true);
    }

    // line 24
    public function block_people($context, array $blocks = array())
    {
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "post"), "people"), "html", null, true);
    }

    // line 25
    public function block_like($context, array $blocks = array())
    {
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "post"), "like"), "html", null, true);
    }

    // line 26
    public function block_picture($context, array $blocks = array())
    {
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "post"), "profile"), "html", null, true);
    }

    // line 27
    public function block_replies($context, array $blocks = array())
    {
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "post"), "replies"), "html", null, true);
    }
