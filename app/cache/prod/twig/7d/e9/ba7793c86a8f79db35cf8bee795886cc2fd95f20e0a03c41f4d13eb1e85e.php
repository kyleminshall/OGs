...
class __TwigTemplate_7de9ba7793c86a8f79db35cf8bee795886cc2fd95f20e0a03c41f4d13eb1e85e extends Twig_Template
{
...
\t\t\t<img src=\"";
        // line 16
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl((("bundles/ogclub/images/" . $this->getContext($context, "picture")) . "")), "html", null, true);
        echo "\" 
\t\t\t\talt=\"Profile\" 
\t\t\t\theight=\"200px\" 
\t\t\t\twidth=\"200px\"
...
\t\t</p>
        ...
        // line 38
        echo twig_escape_filter($this->env, ((array_key_exists("yo", $context)) ? (_twig_default_filter($this->getContext($context, "yo"), "Yo Username")) : ("Yo Username")), "html", null, true);
        echo "\"></input>
